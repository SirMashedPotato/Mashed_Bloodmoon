...
namespace Mashed_Bloodmoon
{
    internal class IngestionOutcomeDoer_PotionWolfsbane : IngestionOutcomeDoer_LycanthropePotion
    {
        ...
        {
            pawn.health.AddHediff(HediffDefOf.Mashed_Bloodmoon_WolfsbanePrevention).Severity = 1f;
        }

        public override void IngestionOutcome_Human(Pawn pawn)
        {
            pawn.health.AddHediff(HediffDefOf.Mashed_Bloodmoon_WolfsbaneResistance).Severity = 1f;

        }

        public override void IngestionOutcome_Lycanthrope(Pawn pawn, Hediff hediff)
        {
            pawn.health.AddHediff(HediffDefOf.Mashed_Bloodmoon_WolfsbaneNausea).Severity = 1f;
